                    ...
                    <tbody>
                        <?php foreach ($allAssignments as $row => $assignment) : ?>
                            ...
                            <tr>
                                ...
                                <td class="border-b px-4 py-2"><img class="w-7 mx-auto cursor-pointer" src="../../Img/icons/create_icon.svg" alt="Create Icon" type="button" data-modal-toggle="defaultModal" data-assign-id="<?= $assignment['assignment_id']; ?>"></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on("click", "#uploadSubmission", function(evt) {
                ...
                let assignmentId = $(this).data('assign-id');
