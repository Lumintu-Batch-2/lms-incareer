...
<body>
    <div class="responsive-top sticky top-0 z-50 bg-white p-5 sm:hidden">
    ...
    <div class="flex items-center">
        ...
        <!-- Right side -->
        <div id="main-content" class="bg-cgray w-full h-screen px-10 py-6 flex flex-col gap-y-6 overflow-y-scroll">
            <!-- Header / Profile -->
